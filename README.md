...
```
npm create cloudflare@latest -- --template=cloudflare/templates/crimson-dawn-91a9
```

## Preview Deployment

A live public deployment of this template is available at [https://crimson-dawn-91a9.templates.workers.dev](https://crimson-dawn-91a9.templates.workers.dev)
